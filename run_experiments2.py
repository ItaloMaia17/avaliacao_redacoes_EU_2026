...
Uso:
    ...
    python run_experiments.py --models llama-3.3-70b gpt-oss-120b \
...
Importante: os valores de `MODELS` (projeto_tcc/models.py) devem ser IDs de
modelo do catálogo do Groq (ex: "llama-3.3-70b-versatile",
"openai/gpt-oss-120b"), não mais os IDs no formato "vendor/modelo:free" do
OpenRouter — a nomenclatura é diferente entre os dois provedores.
